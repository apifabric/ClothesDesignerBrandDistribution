...
@Component({
  selector: 'BrandDesigner-home',
  templateUrl: './BrandDesigner-home.component.html',
  styleUrls: ['./BrandDesigner-home.component.scss']
})
export class BrandDesignerHomeComponent implements AfterViewInit {
